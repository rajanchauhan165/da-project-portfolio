...
SELECT CONCAT(c.first_name, " ", c.last_name) AS Name, ROUND(i.total,2) AS Amount
...
WHERE g.name LIKE "%rock%" GROUP BY First_Name;
...
GROUP BY Artist
ORDER BY Number_Of_Rock_Musics DESC LIMIT 1
;
